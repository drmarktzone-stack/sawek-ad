...
const DEPT_OR_NAV_LINE =
  /مشروبات|بيض|شيبس|كعك|بقوليات|مخللات|مكسرات|قهوه|مثلجات|تنظيف|مستلزمات|خبز|بهارات|آراء|سياسة|تثبيت|طلباتي|السلة|المفضلة|مناطق التوصيل|سوبر|ديجيتال|digital\s*life|برمجة وتطوير|©/;
