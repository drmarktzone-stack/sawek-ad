...
/** Compat aliases so stray Olive/Sand imports resolve to real packs. */
...
export function demoEntry(idOrSlug: string | null | undefined): DemoCatalogEntry | undefined {
  ...
  return DEMO_CATALOG.find((d) =>
    d.id === q || d.slug === q ||
    (q === "peds" && d.slug === "samer") || (q === "samer-peds" && d.slug === "samer") ||
    (q === "clinic" && d.slug === "samer") || (q === "pizza-hut" && d.slug === "pizza") ||
    (q === "aluf-sport" && d.slug === "aluf") || (q === "olive" && d.slug === "pizza") ||
    (q === "sand" && d.slug === "aluf") ||
    (q === "demo-olive-kitchen" && d.slug === "pizza") ||
    (q === "demo-sand-boutique" && d.slug === "aluf"),
  );
}
