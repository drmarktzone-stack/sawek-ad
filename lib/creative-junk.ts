...
export const JUNK_CREATIVE_SRC =
  /\.woff2?(?:\?|$)|\.ttf(?:\?|$)|\.eot(?:\?|$)|\.otf(?:\?|$)|fonts?\/|pixel|1x1|spacer|blank\.gif|formula|equation|math[-_ ]?(poster|board)?|geometric|abstract[-_ ]?(shape|blue)|elementor|placeholder|sprite|upscalemedia|(?:^|\/)group[-_]?\d+/i;
