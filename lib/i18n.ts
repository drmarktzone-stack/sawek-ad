...
export const copy: Dict = {
  ...
  "home.kicker": {
    he: "סטודיו קמפיינים · אילן",
    ar: "ستوديو حملات · إعلان",
    en: "Campaign studio · Ilan",
  },
  "home.pitch": {
    he: "ארבעה שלבים. חמישה סוכנים עם אישור אנושי. עברית, ערבית ואנגלית שוות. בלי לידים בדויים ובלי ROAS מומצא.",
    ar: "أربع خطوات. خمسة وكلاء بموافقة بشرية. العبرية والعربية والإنجليزية متساوية. بلا عملاء مختلقين وبلا عائد مخترع.",
    en: "Four steps. Five agents with human approval. Hebrew, Arabic, and English as equals. No fake leads and no invented ROAS.",
  },
  "home.truth": {
  ...
  "home.stat.agents": { he: "5 סוכנים HITL", ar: "5 وكلاء HITL", en: "5 HITL agents" },
  ...
  "med.appts.lead": { he: "תורים מקומיים. תזכורת וואטסאפ היא קישור/תוכנית — אילן לא שולח הודעות חיות.", ar: "مواعيد محلية. التذكير رابط/خطة — إيلان لا يرسل حياً.", en: "Local appointments. WhatsApp reminder is a link/plan — Ilan does not send live messages." },
