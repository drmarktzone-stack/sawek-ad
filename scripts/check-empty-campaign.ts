...
if (!src.empty.includes("isolateStudioToIntake")) fail("new campaign must isolate studio library from clinic leftovers");
if (!src.active.includes("loadDraft")) fail("latestPack must follow the current draft business");
