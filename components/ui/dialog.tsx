  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 w-[min(92vw,560px)] -translate-x-1/2 -translate-y-1/2 rounded-[28px] border border-navy/10 bg-[#FFFFFF] p-6 shadow-[0_28px_80px_rgba(15,39,68,0.22)]",
          className,
        )}
        {...props}
      >
