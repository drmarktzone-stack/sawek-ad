...
export function CompleteAdCard({
  ...
  return (
    ...
    >
      ...
      {visual ? (
        <figure className="mt-6 overflow-hidden rounded-[18px] border border-[var(--line)] bg-[var(--ivory)]" data-testid="complete-ad-visual">
      ...
      <div className="mt-6 space-y-4">
        ...
        <span className="inline-block rounded-[18px] bg-[var(--store)] px-5 py-2.5 text-sm font-black text-white">
          {loc.cta}
        </span>
      </div>
