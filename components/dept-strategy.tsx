      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card title="AIDA">
          <ul className="space-y-2 text-sm text-muted">
            ...
            <li>
              <strong className="text-gold">I. </strong>
              {s.aida.interest[l]}
            </li>
            <li>
        ...
        <Card title="PAS">
          <ul className="space-y-2 text-sm text-muted">
            <li>
              <strong className="text-gold">P. </strong>
              {s.pas.problem[l]}
            </li>
            <li>
              <strong className="text-gold">A. </strong>
        ...
        <Card title="Hook–Story–Offer">
          <ul className="space-y-2 text-sm text-muted">
            <li>
              <strong className="text-gold">H. </strong>
              {s.hso.hook[l]}
            </li>
            <li>
              <strong className="text-gold">S. </strong>
      ...
      <Card title={t("dept.offerStack")}>
        <ol className="space-y-3">
          {stack.map(([key, body]) => (
            ...
            <p className="text-xs font-black uppercase text-gold">{t(key)}</p>
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {(["tof", "mof", "bof"] as const).map((k) => (
            <div key={k} className="rounded-xl border border-navy/10 p-4">
              <p className="text-xs font-black uppercase text-gold">{k}</p>
