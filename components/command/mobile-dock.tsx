...
export function MobileDock({ onMore }: { onMore: () => void }) {
  ...
  return (
    <nav className="os-dock lg:hidden" aria-label={t("os.dock")}>
      ...
      <button type="button" className="flex flex-1 flex-col items-center justify-center gap-0.5 min-h-[var(--dock-h)] text-[0.62rem] font-extrabold uppercase tracking-wide text-muted" onClick={onMore}>
